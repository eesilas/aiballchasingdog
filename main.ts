...
basic.forever(function () {
    ...
    if (huskylens.isAppear(0, HUSKYLENSResultType_t.HUSKYLENSResultBlock)) {
        ...
        basic.pause(100)
        object_x = huskylens.readeBox(0, Content1.xCenter)
        object_y = huskylens.readeBox(0, Content1.yCenter)
        obj_width = huskylens.readeBox(0, Content1.width)
        obj_height = huskylens.readeBox(0, Content1.height)
